...
Command: npx gltfjsx@6.5.3 public\oxford-models\WingToe-draco.glb 
*/
...
export function WingToeModel(props) {
  const { nodes, materials } = useGLTF("/oxford-models/WingToe-draco.glb");
  ...
  useEffect(() => {
    ...
    const materialUpdates = {
      ...
      "EyeLets Material": { color: eyeletsColor, intensity: 4 },
    };
...
useGLTF.preload("/oxford-models/WingToe-draco.glb");
